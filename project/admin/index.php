...
if(isset($_SESSION['user'])){
    if($_SESSION['user']->ROLE==="ADMIN"){
        ...
        echo"<form method='get'><button type='submit' name='logout' class='btn btn-danger w-100 mb-3'>Log out</button></form>";
        echo"<a href='profile.php' class='btn btn-light p-3 shadow w-100'>Update user information</a>";
        echo"<a href='todolist.php' class='btn btn-light p-3 shadow w-100 p-3 mt-1'>To do list</a>";
        echo"<a href='search.php' class='btn btn-light p-3 shadow w-100 p-3 mt-1'>Search for a user</a>";
    }else {
